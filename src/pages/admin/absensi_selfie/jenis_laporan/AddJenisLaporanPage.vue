    ...
    <q-card class="my-card q-pa-md" v-else flat>
      ...
      >
        ...
        <div class="row items-start">
          <q-input
            standout="bg-positive text-white"
            v-model="form.KODE_JENIS_LAPORAN"
            class="text-white col-4 q-pa-sm"
            label="ID"
            dense
            readonly
          ...
          >
            <template v-slot:prepend>
              <q-icon name="type_specimen" class="q-pr-md" /> </template
          ></q-input>
        </div>
        <div class="row items-start">
          <q-item-label
        ...
        <div class="row items-start">
          ...
          >
            <template v-slot:prepend>
              <q-icon name="schedule" class="q-pr-md" /> </template
          ></q-input>
...
export default {
  ...
  methods: {
    ...
    async onCreate() {
      ...
      await this.$axios
        .post("jenis_laporan/create", this.form)
